...
SCg.Scene = function(options) {
    ...
    this.Scp_procedure_for_delete = [];
    this.arcs_for_attribute = [];
    this.nodes_for_attribute = [];
    this.scpObj = [];
    this.staySCp = false;
    this.points_node_for_bus = [];
...
SCg.Scene.prototype = {
    ...
    deleteObjects: function(objects) {
        ...
        function collect_objects(container, root) {
            ...
            for (idx in root.buses) {
                collect_objects(container, root.buses[idx]);
            }
        }
